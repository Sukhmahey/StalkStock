...
export const getNewsAPI = (category, county = "in") =>
  `${BASE_URL}/top-headlines/category/${category}/${county}.json`;

export const getSourceAPI = (source) => `${BASE_URL}/everything/${source}.json`;
